...
<div class="container-fluid px-4">
    <h1 class="mt-4">Editar Professor: {{ $professore->nome }}</h1>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nome') is-invalid @enderror"
                               id="nome" name="nome" value="{{ old('nome', $professore->nome) }}" required>
                        @error('nome')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('cpf') is-invalid @enderror"
                               id="cpf" name="cpf" value="{{ old('cpf', $professore->cpf) }}" required>
                        @error('cpf')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                               id="email" name="email" value="{{ old('email', $professore->email) }}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telefone') is-invalid @enderror"
                               id="telefone" name="telefone" value="{{ old('telefone', $professore->telefone) }}">
                        @error('telefone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('especialidade') is-invalid @enderror"
                               id="especialidade" name="especialidade" value="{{ old('especialidade', $professore->especialidade) }}" required>
                        @error('especialidade')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('formacao') is-invalid @enderror"
                               id="formacao" name="formacao" value="{{ old('formacao', $professore->formacao) }}">
                        @error('formacao')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            @if(isset($disciplinas))
                                @foreach($disciplinas as $disciplina)
                                    <option value="{{ $disciplina->id }}"
                                        {{-- Pré-seleciona as disciplinas já vinculadas ou as selecionadas em caso de erro de validação --}}
                                        @if(in_array($disciplina->id, old('disciplinas', $professorDisciplinasIds))) selected @endif>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('observacoes') is-invalid @enderror"
                                  id="observacoes" name="observacoes" rows="3">{{ old('observacoes', $professore->observacoes) }}</textarea>
                        @error('observacoes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
