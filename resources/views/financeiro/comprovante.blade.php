...
<body>
    ...
    <div class="comprovante-box">
        ...
        <div class="info-item">
            <span class="info-label">Curso:</span> {{ $curso }}
        </div>
        <div class="info-item">
        ...
        <div class="info-item">
            <span class="info-label">Status:</span> {{ ucfirst($pagamento->status) }}
        </div>

        <div class="comprovante-valor">
            Valor Total: R$ {{ number_format($pagamento->valor, 2, ',', '.') }}
        </div>

        @if($pagamento->observacao)
            <div class="info-item">
                <span class="info-label">Observação:</span> {{ $pagamento->observacao }}
            </div>
        @endif
    ...
    <div class="footer">
        Este comprovante é válido como comprovação de pagamento.
        <br>
